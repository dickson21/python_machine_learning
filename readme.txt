Subject : Machine Learning in Python
Created : 2020-08-26
...
/* Ref */
/*******/
Quick quide machine learning in python
https://www.tutorialspoint.com/machine_learning_with_python/machine_learning_with_python_quick_guide.htm

Machine Learning with python | Machine Learning Tutorial | Python Machine Learning | Simplelearn
youtube.com/watch?v=Q59X518JZHE

How to Setup Your Python Environment for Machine Learning with Anaconda
https://machinelearningmastery.com/setup-python-environment-machine-learning-deep-learning-anaconda/

IBM Machine Learnig with Python
https://www.coursera.org/learn/machine-learning-with-python

IBM data science prof. certificate
...
Iris data set download (ML Repo)
https://archive.ics.uci.edu/ml/datasets/Iris

Iris data set download (Kaggle)
https://www.kaggle.com/saurabh00007/iriscsv?select=Iris.csv

Iris data set download (Gist github)
https://gist.github.com/curran/a08a1080b88344b0c8a7

pima indians diabetes download (Kaggle)
https://www.kaggle.com/kumargh/pimaindiansdiabetescsv


module listing
(base) C:\Users\dickson.cheng>conda list
# packages in environment at C:\Users\dickson.cheng\Anaconda3:
#
